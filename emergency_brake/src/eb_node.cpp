...
public:
    ...
    {
        // Suscribirse al mensaje de odometría
        odom_subscription_ = create_subscription<nav_msgs::msg::Odometry>(
            "/car/odom", 10, std::bind(&EmergencyBrakeNode::odomCallback, this, std::placeholders::_1));
...
private:
    void odomCallback(const nav_msgs::msg::Odometry::SharedPtr msg)
    {
        ...
        // Si se detecta una emergencia, publicar un mensaje Twist para frenar
        // if (emergency_detected)
        // {
        //     geometry_msgs::msg::Twist stop_msg;
        //     stop_msg.linear.x = 0.0; // Detener la velocidad lineal
        //     stop_msg.angular.z = 0.0; // Detener la velocidad angular
...
void laserCallback(const sensor_msgs::msg::LaserScan::SharedPtr msg)
{
    ...
    if (nuevaLongitud > 0)
    {
        ...
        double TTC = range_rate != 0 ? min_distance / (-range_rate) : std::numeric_limits<double>::infinity();
